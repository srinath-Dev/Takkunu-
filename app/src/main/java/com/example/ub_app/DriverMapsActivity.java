...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback,
                ...
                case "":
                    ...
                    geoFireAvailability.setLocation(userID, new GeoLocation(location.getLatitude(), location.getLongitude()), new GeoFire.CompletionListener() {
                        ...
                        public void onComplete(String userId, DatabaseError error) {
                            ...
                            Toast.makeText(DriverMapsActivity.this, "you are available for work ", Toast.LENGTH_LONG).show();
    ...
    {
        Intent startPageIntent = new Intent(DriverMapsActivity.this, WelcomeActivity.class);
