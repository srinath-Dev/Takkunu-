...
public class CustomerMapsActivity extends FragmentActivity implements OnMapReadyCallback,
                ...
                else
                {
                    ...
                    geoFire.setLocation(customerId, new GeoLocation(LastLocation.getLatitude(), LastLocation.getLongitude()), new GeoFire.CompletionListener() {
                        ...
                        public void onComplete(String userId, DatabaseError error) {
                            ...
                            Toast.makeText(CustomerMapsActivity.this, "you are Location is updated ", Toast.LENGTH_LONG).show();
    ...
    {
        Intent startPageIntent = new Intent(CustomerMapsActivity.this, WelcomeActivity.class);
